...
la oración (the sentence) tiene un significado completo.
...
### 1. Verbos que (normalmente) no aceptan objeto (se llaman verbos intransitivos). 
...
> *Se puede usar como transitivo en algunos casos: *Juan corrió el Maratón de Boston.*

> **Se puede usar como transitivo: *Respiramos aire.*
...
### 2. Verbos que aceptan objeto directo (se llaman verbos transitivos). 
...
Hay muchísimos verbos en esta categoría: *tener, escribir, recibir, alquilar, leer, olvidar, encontrar, 
...
tr, vi* o *it.* Esto se refiere, obviamente, a la transitividad del verbo.
...
*Paseo a mi perro.* (Los animales domésticos son personas gramaticalmente hablando.)
...
### 3. Verbos que aceptan objeto directo y objeto indirecto. 
...
(a thing, objeto directo, to a person, objeto indirecto).

Aquí tenemos algunos verbos que normalmente tienen objeto directo y objeto indirecto (a thing to a person). 
...
IDEM (the same) para los verbos *explicar, mostrar, regalar, dar y decir.*
...
En una oración (sentence) podemos tener “extras”, secciones que no son parte de la oración principal, 
...
### 5. De finalidad (con para) o de causa (con por) 
...
## 1. Objeto directo (de cosa). Completar.
